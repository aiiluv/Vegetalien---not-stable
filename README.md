...
After crashing on Earth, strange aliens disguise themselves as harmless vegetables to survive. However, as time passes or when they are injured, their true nature begins to emerge...
...
<img width="1153" height="650" alt="image" src="https://github.com/user-attachments/assets/93616c4c-37df-4c77-a5b7-702df808886d" />
...
```bash
git clone https://github.com/YOUR_USERNAME/Vegetalien.git
```
...
We hope you enjoy our Godot game!!!!!!!!!1

**Find a way to the Safe Zone and uncover the truth behind Vegetalien.**
